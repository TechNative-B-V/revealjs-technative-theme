---
title: "Equinet End 2 End monitoring"
subtitle: Securing the full stack with the power of the cloud!
client:
  name: Mustad BV
  short_name: Mustad
  contact_person: Masoud Banbersta
...
# About this E2E Monitoring { data-background-color="#112f41" }

This proposal is made for improving the quality of the entire Equinet Application.

*from mobile device to database and everyting in between*

## Problem { data-background-color="#112f41" .center}

- Equinet Application has many software and network components
